 ...
 *
 * @version 1.3-beginner (2017-04-11) Methode: setzeGroesse(...) setzeFarbe(...)
 *
 * @changelog 1.3 WECHSELBILD erbt von Knoten und damit von Raum verschiebenUm
 *            greift auf bewegen zurueck Methoden in allen Klassen
 *            vereinheitlicht (bis auf indiv. Methoden) setzeInhalt(int)
 *            hinzugefuegt (bisher nur String) Konstruktor(int,int,int)
 *            hinzugefuegt (bisher nur int,int,String)
 *
