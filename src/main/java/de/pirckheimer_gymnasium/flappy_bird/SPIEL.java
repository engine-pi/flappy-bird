 ...
 * werden kann. (Einzige Voraussetzung ist, dass die engine-alpha-Bibliothek im
 * Suchpfad erreichbar ist.) Es startet alles Notwendige fuer ein Spiel.
 *
 * Beim Konstruktor ohne Parameter gibt es keine Punkte-Anzeigen und auch keine
 * Maus-Interaktion. Die Methoden tick() und tasteReagieren() werden immer
 * automatisch aufgerufen.
 *
 * Beim Konstruktor mit Parametern koennen die linken und rechten
 * Punkte-Anzeigen sowie die Interaktion mit der Maus ein- bzw. ausgeschaltet
 * werden.
 *
 ...
 *
 * @changelog 2.3 Ticker startet NICHT mehr automatisch !!! Methoden-Signaturen
 *            "geglaettet" neue Konstruktoren Methode tasteGedrueckt( int taste
 *            )
 *
 */
public class SPIEL
{
    ...
    /**
     * Erstellt ein einfaches Spiel: Breite 800 , Hoehe 600 , ohne Punktestand
     * und Maus. <br />
     ...
     * @param hoehe  Hoehe des Spielfelds in Pixel
     *
     * @param maus   true, wenn ein Mauszeiger angezeigt werden soll, sonst
     *               false
     */
     ...
     *
     * @param punkteLinks  true : man sieht links eine Punkteanzeige false : man
     *                     sieht sie nicht
     *
     * @param punkteRechts true : man sieht rechts eine Punkteanzeige false :
     *                     man sieht sie nicht
     *
     * @param maus         true : man sieht den Mauszeiger (Klick-Spiel) false :
     *                     man sieht ihn nicht (reines Tastatur-Spiel)
     */
    public SPIEL(int breite, int hoehe, boolean punkteLinks,
            boolean punkteRechts, boolean maus)
    {
    ...
    public void tick()
    {
        // Einfache Bildschirmausgabe. Kann spaeter in Subklasse beliebig
     ...
     *
     * @param ms Die Zeit in Millisekunden zwischen zwei Aufrufen der
     *           <code>tick()</code>-Methode.
     */
    ...
    /**
     * Stoppt die Ticker-Funktion. Die <code>tick()</code>-Methode wird nicht
     * weiter aufgerufen. Der automatische Aufruf der
     ...
     *
     * @param pfad     Der Pfad zu dem Bild (jpg, bmp, png), das das neue
     *                 Maus-Icon werden soll. ZB: "mausicon.png"
     *
     * @param hotspotX Die X-Koordinate des Hotspots fuer das neue Maus-Icon.
     *                 (relativ im Icon)
     *
     * @param hotspotY Die Y-Koordinate des Hotspots fuer das neue Maus-Icon.
     *                 (relativ im Icon)
     */
    public void setzeMausIcon(String pfad, int hotspotX, int hotspotY)
    {
        ea.edu.FensterE.getFenster().mausAnmelden(
                new Maus(new Bild(0, 0, pfad), new Punkt(hotspotX, hotspotY)),
                true);
    }

    /**
     * Sorgt dafuer, dass sowohl der rechte als auch der linke Punktestand
     * sichtbar ist.
     */
    ...
    /**
     * Sorgt dafuer, dass weder der rechte noch der linke Punktestand sichtbar
     * ist.
     */
    ...
    /**
     * Setzt den linken Punktestand. Aenderungen sind nur sichtbar, wenn auch
     * der linke Punktestand sichtbar ist.
     *
    ...
    /**
     * Setzt den rechten Punktestand. Aenderungen sind nur sichtbar, wenn auch
     * der rechte Punktestand sichtbar ist.
     *
     ...
     * naechsten Befehls. !!! VORSICHT !!! Innerhlab der Methode tick() N I C H
     * T verwenden !!!
     *
     ...
     *              Details koennen in der <i>Tabelle aller Tastaturkuerzel</i>
     *              abgelesen werden. Oder man verwendet die ENUM-Typen der
     *              Klasse TASTE (Klassen-Doku lesen).
     *
